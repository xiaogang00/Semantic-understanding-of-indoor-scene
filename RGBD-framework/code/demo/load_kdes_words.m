...
load(['E:\R2014a\bin\scene_labeling_cvpr2012\code\kdes_data/' kdesname '_params.mat'],[kdesname '_params']);
eval(['kdes_words.params=' kdesname '_params;']);

kdes_words.grid_space=2;

load(['E:\R2014a\bin\scene_labeling_cvpr2012\code\kdes_data/' kdesname 'words_400_stanford.mat'],[kdesname '_words']);
